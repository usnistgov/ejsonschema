"""
This suite tests the validation of schemas, including the use the enhanced documentation.
This is currently only testing draft 2020-12 support.
"""
...
enh_doc_schema = os.path.join(schemadir, "enhanced-doc-schema.json")
...
def test_NotesType(validator):
    ...
    schema["properties"] = {
        "sayings": {
            "$ref": "https://data.nist.gov/od/dm/enhanced-doc-schema/v0.2#/$defs/Notes"
        }
    }
...
def test_DocumentationType(validator):
    schema = schemashell.copy()
    schema['$ref'] = "https://data.nist.gov/od/dm/enhanced-doc-schema/v0.2#/$defs/Documentation"
    schema['$id'] = "urn:doc"
    validator.load_schema(schema)
...
def test_PropDocumentationType(validator):
    schema = schemashell.copy()
    schema['$ref'] = "https://data.nist.gov/od/dm/enhanced-doc-schema/v0.2#/$defs/StringPropertyDocumentation"
